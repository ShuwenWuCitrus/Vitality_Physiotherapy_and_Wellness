...
<section>
    <div class="h-[350px] bg-no-repeat bg-cover bg-center bg-[url('../../public/images/index-banner.webp')]">
        <div class="flex flex-col h-full justify-center p-[16px] md:p-[40px] lg:p-[190px] text-[#222222]">
            <h1 class="font-[900] text-[24px] md:text-[32px] lg:text-[40px]">
                Empower your health,<br>
                Revitalize your life
            </h1>
            <div class="mt-[16px]">
                <button class="bg-blue rounded-[25px] p-[8px] md:p-[16px] ease-in duration-200 hover:bg-[#69c4f9]">
                    @auth
                    <a href="{{ url('/services') }}" class="text-[16px] md:text-[20px] font-semibold">Book your appointment</a>
                    @else
                    <a href="{{ route('login') }}" class="text-[16px] md:text-[20px] font-semibold">Book your appointment</a>
                    @endauth
                </button>
            </div>
        </div>
...
<section id="services" class="pt-[40px] pb-[100px] bg-yellow">
    <div class="flex flex-col items-center justify-center text-[#222222]">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-16">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div>
                        <img src="{{ asset('icons/' . $service['name'] . '.webp') }}"
                             class="w-[80px] h-[80px] md:w-[100px] md:h-[100px] pb-3" alt="">
                    </div>
                </div>
            @endforeach
        </div>
...
<section id="about" class="pt-[40px] pb-[100px] bg-gray-200">
    <div class="flex flex-col items-center justify-center text-[#222222]">
        ...
        <div class="max-w-[800px] text-center text-[16px] px-4">
            <p>
