...
@section('content')
    ...
    <section>
        <div class="h-[350px] bg-no-repeat bg-cover bg-center bg-[url('../../public/images/index-banner.webp')]">
            <div class="flex flex-col h-full items-center justify-center p-4 sm:p-8 md:p-16 lg:p-[190px] text-[#222222]">
                <h1 class="font-[900] text-center text-2xl sm:text-3xl md:text-[40px]">
                ...
                <div class="mt-4 sm:mt-[16px]">
                    <button class="bg-blue rounded-[25px] p-3 sm:p-[16px] ease-in duration-200 hover:bg-[#69c4f9]">
                        @auth
                            <a href="{{ url('/services') }}" class="text-base sm:text-[20px] font-semibold">Book your
                                appointment</a>
                        @else
                            <a href="{{ route('login') }}" class="text-base sm:text-[20px] font-semibold">Book your
                                appointment</a>
                        @endauth
                    </button>
                </div>
    ...
    <section id="services" class="pt-8 sm:pt-[40px] pb-16 sm:pb-[100px] px-4 sm:px-8">
    ...
    <section id="professionals" class="pt-8 sm:pt-[40px] bg-white pb-16 sm:pb-[100px]">
        <div class="flex flex-col items-center justify-center text-[#222222]">
            <div class="pb-4 sm:pb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
                @foreach ($professionals as $professional)
                    <div class="flex flex-col items-center justify-start h-full">
                        <div>
                            <p class="py-2 sm:py-3 font-bold text-[14px]"> {{ $professional['name'] }} </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul class="text-xs text-center">
                                @foreach ($professional['services'] as $index => $service)
                                    <li>
                                        {{ $service['name'] }}@if ($index < count($professional['services']) - 1)
                                            ,
                                        @endif
                                    </li>
                                @endforeach
    ...
    <section id="about" class="pt-8 sm:pt-[40px] pb-16 sm:pb-[100px] bg-yellow">
        <div class="flex flex-col items-center justify-center text-[#222222]">
            ...
            <div class="max-w-[800px] text-center text-sm sm:text-[16px] px-4 sm:px-0">
                <p>
                    At Vitality, we believe in empowering your health and revitalizing your life. Our dedicated team of
                    professionals is here to provide personalized services designed to meet your unique needs. Whether
                    you're looking to improve your physical health, mental well-being, or overall lifestyle, we have the
                    expertise and resources to help you achieve your goals.
                </p>
                <p class="mt-4">
                    Our mission is to create a supportive and nurturing environment where you can thrive. We are committed
                    to delivering the highest quality of care and ensuring that each visit leaves you feeling rejuvenated
                    and inspired.
                </p>
            </div>
        </div>
